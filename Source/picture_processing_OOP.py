...
class ResizeandCombine:
    ...
    def make_picture_strip(self, image_list, mode):
        # resize function
        IMAGE_Horizontal_Resize, IMAGE_Vertical_Resize = self.resize_image(list(image_list), Horizontal_x=512, Horizontal_y=320, Vertical_x=556.8, Vertical_y=348)
        ...
        if mode == 1:
            self.combine_images(columns=2, BG_width=1240, BG_height=1432, BG_color=(255, 99, 71, 100),
            ...
            self.combine_images(columns=3, BG_width=1665, BG_height=1100, BG_color=(255, 99, 71, 100),
...
app = ResizeandCombine()
app.make_picture_strip(IMAGE, 1)