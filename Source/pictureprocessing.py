...
def combine_images(columns, BG_width, BG_height, BG_color, new_size_x, new_size_y, space_x, space_y, x_offset, y_offset, image_name, images):
...
Output_IMAGE_Horizontal = "D:\Output Image\Posted_Image_Horizontal.png" # ชื่อไฟล์ Output แบบแนวนอน
Output_IMAGE_Vertical = "D:\Output Image\Posted_Image_Vertical.png" # ชื่อไฟล์ Output แบบแนวตั้ง
